...
function elvira_enqueue(){
  ...
  function elvira_admin_enqueue(){

	$uri = get_theme_file_uri();
    $ver = 1.0;

	  wp_register_style( 'theme-admin-css',  $uri. '/assets/css/admin/admin.css', [], $ver);

	  wp_enqueue_style( 'theme-admin-css');

  }

  add_action( 'admin_enqueue_scripts', 'elvira_admin_enqueue' );
